...
void CLuckyBoxUp::GetBoundingBox(float& l, float& t, float& r, float& b)
{
...
void CLuckyBoxUp::OnNoCollision(DWORD dt)
{
	x += vx * dt;
	y += vy * dt;
};

void CLuckyBoxUp::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
	vy += ay * dt;
...
void CLuckyBoxUp::SetState(int state)
{
